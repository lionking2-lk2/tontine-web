        ...
        try {
            ...
            if (typeTontine === "Rotative") {
                ...
                await configurerEpargneCredit(groupeId, {
                    ...
                    dureeMaxRemboursement: dureeMaxRemboursement
                        ? Number(dureeMaxRemboursement)
                        : 0,
                    modeDecision,
                });
            }
            ...
            setError(
                data?.detail || "Impossible de créer la tontine."
            );
        } finally {
            setLoading(false);
        }
        ...
        <div className="ct-overlay">
            <div className="ct-modal-wizard">
                <div className="ct-wizard-header">
                    <div>
                        <span className="ct-wizard-eyebrow">
                ...
                {etape === 1 && (
                    <form onSubmit={allerEtape2} className="auth-form">
                        ...
                        <div className="ct-row">
                            <div className="form-group">
                                <label htmlFor="montantCotisation">
                                    Cotisation / membre (FCFA) *
                                </label>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setMontantCotisation(e.target.value)
                                    }
                                    required
                                />
                            </div>
                        ...
                        <div className="form-group">
                            <label htmlFor="nombreMaxMembres">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNombreMaxMembres(e.target.value)
                                }
                            />
                        </div>
                    ...
                    <form onSubmit={handleCreer} className="auth-form">
                        <div className="form-group">
                            ...
                            <div className="ct-type-cards ct-type-cards-compact">
                                <div
                                    className={`ct-type-card-mini ${
                                        typeTontine === "Rotative"
                                            ? "selected"
                                            : ""
                                    }`}
                                    onClick={() =>
                                        setTypeTontine("Rotative")
                                    }
                                >
                                    <RefreshCw
                                        size={22}
                                    ...
                                    <p>
                                        Tirage ou attribution du lot par tour
                                    </p>
                                </div>
                                ...
                                >
                                    ...
                                    <p>
                                        Caisse d'épargne avec possibilité de prêt
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        {typeTontine === "Rotative" ? (
                                ...
                                <div className="ct-radio-group">
                                    <label>
                                        <input
                                            type="radio"
                                            checked={
                                                modeAttribution === "Ordre"
                                            }
                                            onChange={() =>
                                                setModeAttribution("Ordre")
                                            }
                                        />
                                        Ordre défini
                                    </label>
                            ...
                            <>
                                ...
                                <div className="ct-row">
                                    <div className="form-group">
                                        <label htmlFor="dureeMaxRemboursement">
                                            Durée max remboursement (mois)
                                        </label>
                                    ...
                                    <div className="form-group">
                                        ...
                                        >
                                            <option value="DecisionBureau">
                                                Décision du bureau
                                            </option>

                                            <option value="VoteMembres">
                                                Vote des membres
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div className="form-group">
                                    <label htmlFor="dateRedistribution">
                                        Date de redistribution
                                    </label>
